...
public class LaserEyes : MonoBehaviour
{
	...
	void Update ()
	{
        ...
        if (botCtrl.lookWeight >= 0.9f && !shot && botCtrl.isEnemyInView && !botCtrl.isDie && botCtrl.isCanGetMemory)
		{
        ...
        if (laserL != null && botCtrl.isEnemyInView && !botCtrl.isDie && botCtrl.isCanGetMemory)
		{
